...
# # #  ran this to get the subset indexes for testing/ training data
# opath = [os.path.join(os.getcwd(),'task2_subset.npy'),os.path.join(os.getcwd(),'task2_subsetElse.npy')]
# generate_subset(totalSize=10000,number=8000,doRandom=True,
#                     opath=os.getcwd(),doSave=True)
